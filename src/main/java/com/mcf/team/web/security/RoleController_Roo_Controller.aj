...
import com.mcf.team.web.security.RoleController;
...
privileged aspect RoleController_Roo_Controller {
    ...
    public String RoleController.create(@Valid UserRole userRole, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        uiModel.asMap().clear();
        userRole.persist();
        return "redirect:/security/roles/" + encodeUrlPathSegment(userRole.getId().toString(), httpServletRequest);
    }
    ...
    public String RoleController.update(@Valid UserRole userRole, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, userRole);
    ...
    void RoleController.populateEditForm(Model uiModel, UserRole userRole) {
